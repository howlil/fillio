...
export function Button({
  ...
  return (
    <button
      className={classes(
        'inline-flex h-[34px] min-h-[34px] items-center justify-center gap-1.5 whitespace-nowrap rounded-[7px] border px-2.5 text-[13px] font-medium shadow-none transition-colors duration-120 focus-visible:border-app-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-accent-soft disabled:cursor-not-allowed disabled:opacity-50',
