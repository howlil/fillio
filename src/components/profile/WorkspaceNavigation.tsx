...
const navItemBase =
  'jobflow-nav-item relative flex h-9 min-h-9 w-9 items-center justify-center rounded-control border text-left text-[13px] font-medium transition-[width,padding,gap,background-color,border-color,color] duration-160 ease-out focus-visible:border-app-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-accent/25 group-data-[expanded=true]/sidebar:w-full group-data-[expanded=true]/sidebar:justify-start group-data-[expanded=true]/sidebar:gap-2 group-data-[expanded=true]/sidebar:px-2';
              ...
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span className="pointer-events-none max-w-0 overflow-hidden truncate whitespace-nowrap opacity-0 transition-[max-width,opacity] duration-160 ease-out group-data-[expanded=true]/sidebar:max-w-[152px] group-data-[expanded=true]/sidebar:opacity-100">
                      {item.label}
                    </span>
                  </button>
                );
